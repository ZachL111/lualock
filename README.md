...
lualock is a Lua project for sandbox. It focuses on this technical goal: Run capability-filtered plugins with deterministic resource policy checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 153, risk penalty 6, latency penalty 3, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
