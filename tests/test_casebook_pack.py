"""Regression checks for the lualock casebook."""
...
from casebook.harness import assert_expected, lualock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lualock_summary(), assert_expected())
